RSpec.describe 'Comments', type: :request do
  ...
  let(:long_comment) { FFaker::Lorem.paragraphs(3).join }
      ...
      response '201', 'Created Comment' do
        it 'returns created Comment' do |example|
          params = { data: { type: :comments, attributes: {
            ...
            image: fixture_file_upload(Rails.root.join('spec', 'fixtures', 'images', 'sample.jpg'), 'image/jpeg')
          } } }
        ...
        it 'returns an error' do
          params = {
            data: {
              ...
              attributes: {
                body: long_comment,
                image: fixture_file_upload(Rails.root.join('spec', 'fixtures', 'images', 'fake_image.png'))
              }
            }
          }
